    ...
    return (
        <InAppHB navigation={props.navigation} headerTitleText={"Withdrawl Via Bank Transfer"} >
            <View style={style.formView}>
                ...
                <View style={style.inputCont}>
                    <TextInput style={[style.input, DefaultStyle.centeredXY]} inputMode="numeric" placeholderTextColor="#606060" placeholder="Amount" value={amount}
                    maxLength={10} onChangeText={value => {
                            setAmount(value.replace(/[^0-9.]/g,"").trim());
                        }}
                     />
                     <TextInput style={[style.input, DefaultStyle.centeredXY]} placeholderTextColor="#606060" placeholder="Narration" value={narration}
